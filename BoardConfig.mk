...
# Releasetools
TARGET_RELEASETOOL_OTA_FROM_TARGET_SCRIPT := $(LOCAL_PATH)/releasetools/i9103_ota_from_target_files
TARGET_RELEASETOOL_IMG_FROM_TARGET_SCRIPT := $(LOCAL_PATH)/releasetools/i9103_img_from_target_files

# Custom squisher, final step script
TARGET_CUSTOM_RELEASETOOL := device/samsung/i9103/releasetools/squisher

# Assert
TARGET_OTA_ASSERT_DEVICE := galaxyr,i9103,GT-I9103
